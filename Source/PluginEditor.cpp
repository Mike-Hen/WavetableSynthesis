...
Wsynth_v1AudioProcessorEditor::Wsynth_v1AudioProcessorEditor (Wsynth_v1AudioProcessor& p)
    : AudioProcessorEditor (&p), processor (p), oscGui(p), filt1(p), filt2(p), dist1(p), envGui(p), lfo1(p), lfo2(p)
{
...
void Wsynth_v1AudioProcessorEditor::resized()
{
	...
	lfo1.setBounds(getWidth() - 160, 140, 150, 80);
	lfo2.setBounds(getWidth() - 160, 230, 150, 80);
