/*
  ==============================================================================
    ...
    SynthVoice.h
    Created: 11 Jan 2020 10:37:57am
    Author:  MHENDER4
...
public:
	SynthVoice()
	{
		...
		//lfo1.setFrequency(3.0f);                                    
	}

	void prepare(float blockSize, float sampleRate, float numChannels)
	{
//		lfo1.prepare({ sampleRate / lfoUpdateRate, blockSize, numChannels });
	}
	...
	//void getWaveform1(float* waveform)
	//{
	//	waveform1 = 0;//*waveform;
	//}
	//void getWaveform2(float* waveform)
	//{
	//	waveform2 = 0;//*waveform;
	//}
	...
	//Array<float> calcWaveTable(Array<float> waveTable, float waveform, float gain)
	//{
	//	waveTable.clear();
	//	sineTable.clear();
	//	squareTable.clear();
	...
	//		for (int i = 0; i < wtSize; i++)
	//		{
	//			waveTable.insert(i, gain * sin(2.0 * double_Pi * i / wtSize));
	//		}
	//	}
	//	else if (waveform == 1)
	//	{
	...
	//		}
	//	}
	//	else if (waveform == 2.0f)
	//	{
	//		double increment = 2 / wtSize;
	//		double count = 0;
	//		for (int i = 0; i < wtSize; i++)
	//		{
	//			waveTable.insert(i, gain * (2 - count) - 1);
	//			count = count + increment;
	//		}
	//	}
	//	else if (waveform == 3.0f)
	//	{
	//		double increment = 4 / wtSize;
	//		double count = 0;
	//		for (int i = 0; i < wtSize; i++)
	//		{
	//			if (i < (wtSize / 2))
	//			{
	//				waveTable.insert(i, gain * count - 1);
	//				count = count + increment;
	//			}
	//			else if (i == (wtSize / 2))
	//			{
	...
	void renderNextBlock(AudioBuffer<float> &outputBuffer, int startSample, int numSample)
	{
		...
		//	{
		//		float input_sample = outputBuffer.getSample(channel, sample);
		//		float cur_sample = lfo1.modulate(input_sample);
		//		outputBuffer.setSample(channel, sample, cur_sample);
		//	}
		//}
	}
